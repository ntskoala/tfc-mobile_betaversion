...
export class LoginPage {
  ...
  constructor(public navCtrl: NavController, menu: MenuController,private distancia: Distancia, private data:Data, private config: Config) {
    menu.enable(false);
